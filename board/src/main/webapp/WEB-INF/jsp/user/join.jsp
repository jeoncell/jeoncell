  ...
  <div class="container">
  	...
  	<div class="col-lg-4">
  		<div class="jumbotron" style="padding-top: 20px;">
  				...
  				<div class="form-group">
  					<input type="text" class="form-control" placeholder="이메일" name="userEmail" id="userEmail" maxlength="30">
  				</div>
  				<div style="height:20px"></div>
  				<div class="form-group text-center">
  				
  				<button type="submit" class="btn btn-primary form-control" >회원가입 완료</button>
				</div>	
  			</form>
  		</div>
  	</div>
